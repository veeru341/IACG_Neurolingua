...
function Onboard() {
    ...
    return new Promise((resolve, reject) => {
      ...
      switch (pageNumber) {
        ...
        case 5:
          ...
          break;
        case 6:
          if (countryFrom === "" || regionFrom === "" || countryLive === "" || regionLive === "") {
  ...
  const handleSubmit = () => {
    const onBoardPayload = formOnboardPayload({...certificateFormData, firstName, lastName, gender, typeOfTeacher, dob, languageSpeak, languageTeach, countryFrom, countryLive, regionFrom, regionLive, phoneNumber, videoLink, description, profilePic, motherLanguage, educationFormData, teachingFormData });
          ...
          <div className="genderImageViewDiv">
            <div>
              <img
                ...
                alt="teacherType_img"
                className={`teacherTypeImg ${typeOfTeacher === "Professional Teacher" ? "selectedImg" : ""}`}
              />
              <br></br>
            ...
            <div>
              <img
                ...
                id={"communityTeacher"}
                className={`teacherTypeImg ${typeOfTeacher === "Community Teacher" ? "selectedImg" : ""}`}
              />
              <br></br>
      ...
      return (
        <div className="profilePicView">
          <button onClick={() => profilePicRef.current.click()} className="uploadPicPlaceholder">
            {profilePic ? <img className="uploadPicPlaceholder" src={URL.createObjectURL(profilePic)} alt="" /> : <h2>Upload your photo</h2>}
          </button>
          <input
            accept="image/*"
